...
namespace Platform.Data.Doublets.Sequences.Walkers
{
    ...
    public class LeftSequenceWalker<TLinkAddress> : SequenceWalkerBase<TLinkAddress> where TLinkAddress : struct, IUnsignedNumber<TLinkAddress>, IComparisonOperators<TLinkAddress, TLinkAddress, bool>
    {
        /// <summary>
        /// <para>
